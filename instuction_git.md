...
## Ветвление
Ветви в Git работы с кодом без изменения главной ветви. Это нужно чтобы исходный код продолжал работу во время модернизации. После проверки работоспособности новой ветви, она вливается в основную ветвь.
